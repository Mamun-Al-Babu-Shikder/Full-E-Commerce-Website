...
(function($) {
  ...
  var ss = {
    ...
    initDropDownCart: function() {
      ...
      $(document).on('click', '.minicart-header .btn-remove2', function(event) {
    ...
    initToolsCart: function() {
      ...
      $(document).on('click', '.so-groups-sticky .popup-mycart .btn-remove2', function(event) {
        event.preventDefault();
    ...
    doUpdateDropdownCart: function(cart) {
      ...
      template += '</a>';
      template += '<a href="javascript:void(0)"  title="Remove This Item" class="btn-remove2">&nbsp;</a>';
      template += '</div>';
      ...
      if (cart.item_count > 0) {
        ...
        $('.minicart-header .btn-remove2').click(function(event) {
          event.preventDefault();
          var productId = $(this).parents('.item').data('product_id');
          Shopify.removeItem(productId, function(cart) {
            ss.doUpdateDropdownCart(cart);
    ...
    doUpdateToolsCart: function(cart) {
      ...
      template += '<td class="text-right last"><a href="javascript:;" data-productid="{ID}" return false;" class="btn-remove2"><i class="fa fa-trash"></i></a></td>';
      template += '</tr>';
...
//         });
        ...
        $('.product-card__gallery .item-img').on("mouseover touchstart", function (e) {
          var $product = $(this).parents('.product-item-container');
          var thumb_src = $(this).attr("data-src");
          
          $product.addClass('loading-image');
          $(this).addClass('thumb-active').siblings().removeClass('thumb-active');
          $(this).closest('.product-item-container').find('.img-responsive.s-img').attr("src",thumb_src).one('load', function() {
